...
>*Answer 1:*
The saturation is likely a result of areas carrying capacity being reached, while also being a result of the nutrient limited area. Only a certain greenness threshhold can most likely be reached. 
<br>
...
>*Answer 2:*
The estimates for the common parameters do not deviate much from each other however the lambda parameter in the full model is more significant. 
<br>
...
>*Answer 5:*
Yes, the full model which has a much lower AIC weight as compared to the simple model 
<br>
...
>*Answer 6:*
The AIC of MLE and NLS models should not be compared as the AIC theory requires that log likelihood of the data has been maximized. Also our NLS models are non linear. 
<br>
